...
const HEADLINE: DemoPlayerSpec[] = [
  // ------------------------------------------------------------------ tier 1
  { id: 'p001', name: 'Marcus Vance', position: 'RB', team: 'KC', adp: 1.6, searchRank: 1,
  ...
  { id: 'p002', name: 'Devin Okafor', position: 'WR', team: 'CIN', adp: 2.8, searchRank: 2,
  ...
  { id: 'p003', name: 'Kai Brennan', position: 'WR', team: 'BUF', adp: 3.4, searchRank: 3,
    news: { net: 3, items: 7 },
    seasonMarkets: [
  ...
  { id: 'p004', name: 'Roshan Villiers', position: 'RB', team: 'PHI', adp: 4.9, searchRank: 5,
    news: { net: -7, items: 12, net30: -5, net7: -3, lastItemHoursAgo: 14 },
    seasonMarkets: [
      { market: 'season_rush_yards', line: 1105 },
      { market: 'season_rush_tds', line: 9.5 },
    ] },
  { id: 'p005', name: 'Owen Fitzgerald', position: 'WR', team: 'SF', adp: 6.2, searchRank: 4,
    news: { net: 2, items: 6 },
    seasonMarkets: [
      { market: 'season_receiving_yards', line: 1155 },
      { market: 'season_receptions', line: 88 },
    ] },
  { id: 'p006', name: 'Silas Mbeki', position: 'RB', team: 'GB', adp: 7.1, searchRank: 8,
    news: { net: 1, items: 5 },
    seasonMarkets: [{ market: 'season_rush_yards', line: 1040 }, { market: 'season_rush_tds', line: 8.5 }] },
  { id: 'p007', name: 'Julian Reyes', position: 'RB', team: 'MIA', adp: 8.8, searchRank: 6,
    status: 'Questionable',
  ...
  { id: 'p008', name: 'Silas Brandt', position: 'WR', team: 'DET', adp: 10.4, searchRank: 9,
  ...
  { id: 'p009', name: 'Emeka Falade', position: 'WR', team: 'HOU', adp: 41.2, searchRank: 34,
  ...
  // ---------------------------------------------------------- quarterbacks
  { id: 'p010', name: 'Trey Halloran', position: 'QB', team: 'BAL', adp: 24.5, searchRank: 12,
    news: { net: 4, items: 8 },
    seasonMarkets: [{ market: 'season_pass_yards', line: 4380 }, { market: 'season_pass_tds', line: 31.5 }] },
  { id: 'p011', name: 'Emil Draeger', position: 'QB', team: 'MIN', adp: 27.0, searchRank: 15,
    news: { net: 1, items: 4 },
    seasonMarkets: [{ market: 'season_pass_yards', line: 4200 }, { market: 'season_pass_tds', line: 28.5 }] },
  { id: 'p012', name: 'Jonah Priestley', position: 'QB', team: 'TB', adp: 29.4, searchRank: 19,
    news: { net: 0, items: 3 },
    seasonMarkets: [{ market: 'season_pass_yards', line: 4055 }] },
  { id: 'p013', name: 'Casey Lindqvist', position: 'QB', team: 'DEN', adp: 31.1, searchRank: 22,
    news: { net: -1, items: 5 } },
  /* Then a twenty-pick hole. Four in a tier is not a shortage; this is. */
  { id: 'p014', name: 'Ruben Castellanos', position: 'QB', team: 'PIT', adp: 61.8, searchRank: 40,
    news: { net: 2, items: 4 } },
  { id: 'p015', name: 'Wes Ihejirika', position: 'QB', team: 'CLE', adp: 74.2, searchRank: 56 },

  // ------------------------------------------------------------ tight ends
  { id: 'p016', name: 'Andre Sotelo', position: 'TE', team: 'DAL', adp: 21.7, searchRank: 11,
    status: 'Questionable',
  ...
  { id: 'p017', name: 'Miles Barrowman', position: 'TE', team: 'ATL', adp: 25.9, searchRank: 20,
    news: { net: 2, items: 5 },
  ...
  { id: 'p019', name: 'Grant Aldous', position: 'TE', team: 'WAS', adp: 58.0, searchRank: 49 },
  { id: 'p020', name: 'Nate Kowalski', position: 'TE', team: 'CHI', adp: 88.4, searchRank: 72, status: 'IR',
    news: { net: -4, items: 5, net30: -4, lastItemHoursAgo: 40 } },

  // --------------------------------------------------- the middle rounds
  { id: 'p021', name: 'Bo Ashworth', position: 'RB', team: 'LAR', adp: 12.6, searchRank: 10,
    news: { net: 0, items: 4 },
    seasonMarkets: [{ market: 'season_rush_yards', line: 920 }] },
  { id: 'p022', name: 'Cal Whitfield', position: 'WR', team: 'NYJ', adp: 14.1, searchRank: 13,
    status: 'Doubtful',
    news: { net: -5, items: 9, net30: -4, net7: -2 } },
  { id: 'p023', name: 'Ike Sandoval', position: 'RB', team: 'MIN', adp: 16.8, searchRank: 17,
    news: { net: 2, items: 6 },
    seasonMarkets: [{ market: 'season_rush_yards', line: 860 }, { market: 'season_receptions', line: 48 }] },
  { id: 'p024', name: 'Dax Merriweather', position: 'WR', team: 'LAC', adp: 18.2, searchRank: 16,
    news: { net: 1, items: 5 } },
  { id: 'p025', name: 'Yusuf Adeyemi', position: 'WR', team: 'TB', adp: 19.5, searchRank: 18,
    news: { net: 4, items: 7, net7: 2 } },
  { id: 'p026', name: 'Corbin Ledoux', position: 'RB', team: 'NO', adp: 22.9, searchRank: 21,
    news: { net: -1, items: 4 } },
  { id: 'p027', name: 'Anton Brekke', position: 'WR', team: 'ARI', adp: 26.4, searchRank: 24,
    news: { net: 0, items: 3 } },
  { id: 'p028', name: 'Rey Villanueva', position: 'RB', team: 'IND', adp: 30.2, searchRank: 26,
    news: { net: 3, items: 6, net7: 2, lastItemHoursAgo: 20 } },
  { id: 'p029', name: 'Ollie Trant', position: 'WR', team: 'JAX', adp: 33.7, searchRank: 29 },
  { id: 'p030', name: 'Femi Adebayo', position: 'RB', team: 'CHI', adp: 35.1, searchRank: 31,
    news: { net: -2, items: 5 } },
  { id: 'p031', name: 'Karl Ostrowski', position: 'WR', team: 'PIT', adp: 37.8, searchRank: 33 },
  { id: 'p032', name: 'Dane Kirkbride', position: 'RB', team: 'TEN', adp: 39.4, searchRank: 36,
    news: { net: 1, items: 3 } },
  { id: 'p033', name: 'Vasco Pinheiro', position: 'WR', team: 'NE', adp: 43.6, searchRank: 38 },
  { id: 'p034', name: 'Otis Kramarik', position: 'RB', team: 'NYG', adp: 46.0, searchRank: 41 },
  { id: 'p035', name: 'Jae-won Sohn', position: 'WR', team: 'LV', adp: 48.5, searchRank: 43,
    news: { net: 2, items: 4 } },
  { id: 'p036', name: 'Bruno Tessaro', position: 'RB', team: 'CAR', adp: 51.2, searchRank: 46 },
  { id: 'p037', name: 'Kwame Boateng', position: 'WR', team: 'BAL', adp: 53.0, searchRank: 47,
    news: { net: 5, items: 6, net7: 3, lastItemHoursAgo: 11 } },
  { id: 'p038', name: 'Lorne Whitaker', position: 'RB', team: 'GB', adp: 56.4, searchRank: 51 },
  { id: 'p039', name: 'Idris Manso', position: 'WR', team: 'MIA', adp: 59.8, searchRank: 53 },
  { id: 'p040', name: 'Ephraim Doss', position: 'RB', team: 'DEN', adp: 63.3, searchRank: 58,
    news: { net: -1, items: 3 } },
];
...
export const WORLD_PLAYERS: DemoPlayerSpec[] = [...HEADLINE, ...depthPool()];
